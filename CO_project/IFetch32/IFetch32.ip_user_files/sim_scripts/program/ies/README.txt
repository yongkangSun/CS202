...
#
# Generated by export_simulation on Tue Apr 27 12:04:05 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './program.sh' script.

./program.sh -reset_run
...
./program.sh -noclean_files

For more information on the script, please type './program.sh -help'.
